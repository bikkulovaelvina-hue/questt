...
const AIAnalytics = (function() {
    ...
    // Эта функция теперь будет получать данные из глобальной переменной sceneScales
    // которая загружается из базы данных
    function getScaleName(sceneCode) {
        // Проверяем, загружены ли данные из БД (глобальная переменная sceneScales)
        if (typeof window !== 'undefined' && window.sceneScales && window.sceneScales[sceneCode]) {
            return window.sceneScales[sceneCode].join(', ');
        }
        // Fallback на случай, если данные ещё не загружены
        const fallbackMap = {
            "2": "Аффективность, Уникальность",
            "3A": "Демонстративность, Уникальность, Временная перспектива",
            "3B": "Демонстративность, Уникальность, Временная перспектива",
            "5": "Аффективность",
            "6": "Демонстративность, Аффективность",
            "8": "Аффективность",
            "11": "Аффективность",
            "12": "Аффективность",
            "14": "Демонстративность, Уникальность",
            "16A": "Демонстративность, Уникальность, Социальный пессимизм",
            "16B": "Демонстративность, Уникальность, Социальный пессимизм",
            "17": "Социальный пессимизм",
            "19": "Демонстративность, Уникальность, Временная перспектива",
            "20": "Несостоятельность, Временная перспектива",
            "21": "Несостоятельность, Временная перспектива",
            "22": "Несостоятельность",
            "23": "Несостоятельность",
            "24": "Социальный пессимизм",
            "25": "Социальный пессимизм",
            "26": "Социальный пессимизм",
            "27": "Слом культурных барьеров",
            "28": "Слом культурных барьеров",
            "30": "Максимализм",
            "31": "Антисуицидальный фактор",
            "33": "Социальный пессимизм",
            "35": "Слом культурных барьеров",
            "37": "Максимализм",
            "39": "Временная перспектива",
            "41": "Временная перспектива",
            "42": "Антисуицидальный фактор",
            "44": "Несостоятельность"
        };
        return fallbackMap[sceneCode] || "—";
    }
